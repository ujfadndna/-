...
void Redraw_Mainmenu(void)
{
  ...
  Gui_DrawFont_GBK16(16, 0, BLUE, GRAY0, "无名创新");
...
void Font_Test(void)
{
  ...
  delay_ms(1000);
  Lcd_Clear(GRAY0);
  Gui_DrawFont_GBK16(16, 30, YELLOW, GRAY0, "无名创新");
  Gui_DrawFont_GBK16(16, 50, BLUE, GRAY0, "专注液晶批发");
  Gui_DrawFont_GBK16(16, 70, RED, GRAY0, "全程技术支持");
  Gui_DrawFont_GBK16(0, 100, BLUE, GRAY0, "Tel:15871778515");
  Gui_DrawFont_GBK16(0, 130, RED, GRAY0, "QQ:1094744141");
  delay_ms(1800);
}
